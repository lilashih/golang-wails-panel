...
$dockerfilePath = Join-Path $PSScriptRoot "Dockerfile.linux-appimage"
...
$stagingDir = Join-Path $repoRoot "tmp/docker-linux-appimage-$Arch"
...
Write-Host "Linux AppImage 已同步至：$resolvedOutputDir"
